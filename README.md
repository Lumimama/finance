...
| [month-end-close](month-end-close) | The close as a dependency graph: critical path recomputed monthly, flux review that refuses to certify an unexplained breach, sign-off state machine |
